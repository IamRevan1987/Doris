...
def ask_the_holocron(question: str) -> str:
    ...
    print(f"[DEBUG] ask_the_holocron called with: {question}")
    try:
        with httpx.Client(timeout=30.0) as client:
            ...
            return json_response.get("answer", "The Holocron is silent.")
    except Exception as e:
        print(f"[DEBUG] Exception in ask_the_holocron: {e}")
